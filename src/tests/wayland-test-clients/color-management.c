...
{
  struct xx_image_description_creator_icc_v4 *creator_icc;
  ImageDescriptionContext image_description_context;
  int32_t icc_fd;
  struct stat stat = { 0 };

  creator_icc =
    xx_color_manager_v4_new_icc_creator (display->color_management_mgr);
  ...
  xx_image_description_creator_icc_v4_set_icc_file (creator_icc,
                                                    icc_fd,
                                                    0,
                                                    stat.st_size);
  ...
  *image_description =
    xx_image_description_creator_icc_v4_create (creator_icc);
  xx_image_description_v4_add_listener (
    *image_description,
    &image_description_listener,
    &image_description_context);
