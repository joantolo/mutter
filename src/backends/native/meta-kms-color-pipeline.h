...
uint64_t meta_kms_color_pipeline_get_id (MetaKmsColorPipeline *color_pipeline);

GSList * meta_kms_color_pipeline_get_color_ops (MetaKmsColorPipeline *color_pipeline);
