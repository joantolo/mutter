                                      ...
                                      int                n_samples)
{
  ...
  switch (output_format)
    ...
    case COGL_PIXEL_FORMAT_RGBA_FP_32323232:
      cms_output_format = TYPE_RGBA_FLT;
      break;
    case COGL_PIXEL_FORMAT_RGBX_FP_16161616:
      cms_output_format = TYPE_RGBA_HALF_FLT;
      break;
    case COGL_PIXEL_FORMAT_RGBX_8888:
      cms_output_format = TYPE_RGBA_8;
      break;
    default:
      g_warning ("Transform with invalid output format");
      return;
    }
